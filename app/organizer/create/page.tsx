...
const FeatureCard = ({ icon, title, children }: { icon: React.ReactNode, title: string, children: React.ReactNode }) => (
  <div className="flex flex-col items-center text-center p-6 rounded-lg bg-white/5 border border-white/10 transition-transform duration-300 hover:-translate-y-2">
...
export default function HomePage() {
  return (
    <div className="relative min-h-screen w-full overflow-x-hidden bg-slate-950 text-white font-body">
      {/* Background Glows */}
      <div className="absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2 w-[60vw] h-[60vw] max-w-[800px] max-h-[800px] rounded-full bg-purple-500/30 blur-[150px] z-0" />
      <div className="absolute bottom-0 right-0 translate-x-1/3 translate-y-1/3 w-[50vw] h-[50vw] max-w-[700px] max-h-[700px] rounded-full bg-pink-500/20 blur-[120px] z-0" />
      <div 
        className="absolute inset-0 z-0 h-full w-full bg-cover bg-center opacity-30" 
        style={{backgroundImage: "url(/background-particles.png)"}} 
      />
      ...
      <main className="relative z-20">
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            <div className="text-center lg:text-left">
              ...
              <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center lg:justify-start">
                <Button asChild size="lg" className="h-12 w-full sm:w-auto bg-gradient-to-r from-pink-500 to-purple-500 text-white font-bold shadow-[0_0_20px_#d946ef]">
                  <Link href="/join">Play Now</Link>
                </Button>
                <Button asChild size="lg" className="h-12 w-full sm:w-auto become-organizer-button" variant="outline">
            ...
            <div className="relative flex items-center justify-center">
                <Image
                    ...
                    height={600}
                    priority
                    className="h-auto w-full max-w-[500px] -rotate-[5deg] transition-transform duration-300 hover:rotate-0 hover:scale-105 lg:rotate-[15deg]"
                />
            </div>
          </div>
        </div>
        ...
        <div id="about" className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:py-24 lg:px-8">
           <div className="text-center">
             <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl">The Ultimate Online Tambola Experience</h2>
             <p className="mx-auto mt-4 max-w-3xl text-lg text-white/60">
                Housie Empire is revolutionizing the classic game of Tambola (or Housie) for the digital age. Our platform provides a seamless, secure, and exhilarating experience for everyone, from casual players to professional organizers. We believe in connecting people and creating moments of fun and excitement, all from the comfort of your home.
             </p>
           </div>
        </div>
