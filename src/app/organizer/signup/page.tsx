...
export default function OrganizerSignUp() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      console.error("Organizer Sign Up Error:", error);
      toast({
        variant: "destructive",
    ...
    <main className="flex items-center justify-center min-h-screen py-8 bg-background">
      <Card className="w-full max-w-sm mx-4">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-bold">Organizer Sign Up</CardTitle>
        ...
        <CardContent>
          ...
          <div className="mt-4 text-center text-sm">
            ...
            <Link href="/organizer/login" className="underline text-primary">
              Login
            </Link>
          </div>
